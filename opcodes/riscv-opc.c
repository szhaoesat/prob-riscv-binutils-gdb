...
/**************************************     End of Gap9              ***************************************************/
/***********************************************************************************************************************/
//add for probabilistic models
{"pru.add.down",    "Xgap9", "d,s,t", MATCH_PRU_ADD_DOWN, MASK_PRU_ADD_DOWN, match_opcode, 0},
{"pru.add.hhl",     "Xgap9", "d,s,t", MATCH_PRU_ADD_HHL, MASK_PRU_ADD_HHL, match_opcode, 0},
{"pru.add.left",    "Xgap9", "d,s,t", MATCH_PRU_ADD_LEFT, MASK_PRU_ADD_LEFT, match_opcode, 0},
{"pru.add.lhl",     "Xgap9", "d,s,t", MATCH_PRU_ADD_LHL, MASK_PRU_ADD_LHL, match_opcode, 0},
{"pru.add.right",   "Xgap9", "d,s,t", MATCH_PRU_ADD_RIGHT, MASK_PRU_ADD_RIGHT, match_opcode, 0},
{"pru.add.up",      "Xgap9", "d,s,t", MATCH_PRU_ADD_UP, MASK_PRU_ADD_UP, match_opcode, 0},
{"pru.div.hhl",     "Xgap9", "d,s,t", MATCH_PRU_DIV_HHL, MASK_PRU_DIV_HHL, match_opcode, 0},
{"pru.div.lhl",     "Xgap9", "d,s,t", MATCH_PRU_DIV_LHL, MASK_PRU_DIV_LHL, match_opcode, 0},
{"pru.divu.hhl",    "Xgap9", "d,s,t", MATCH_PRU_DIVU_HHL, MASK_PRU_DIVU_HHL, match_opcode, 0},
{"pru.divu.lhl",    "Xgap9", "d,s,t", MATCH_PRU_DIVU_LHL, MASK_PRU_DIVU_LHL, match_opcode, 0},
{"pru.mul.hhl",     "Xgap9", "d,s,t", MATCH_PRU_MUL_HHL, MASK_PRU_MUL_HHL, match_opcode, 0},
{"pru.mul.lhl",     "Xgap9", "d,s,t", MATCH_PRU_MUL_LHL, MASK_PRU_MUL_LHL, match_opcode, 0},
{"pru.mulh.hhl",    "Xgap9", "d,s,t", MATCH_PRU_MULH_HHL, MASK_PRU_MULH_HHL, match_opcode, 0},
{"pru.mulh.lhl",    "Xgap9", "d,s,t", MATCH_PRU_MULH_LHL, MASK_PRU_MULH_LHL, match_opcode, 0},
{"pru.mulhsu.hhl",  "Xgap9", "d,s,t", MATCH_PRU_MULHSU_HHL, MASK_PRU_MULHSU_HHL, match_opcode, 0},
{"pru.mulhsu.lhl",  "Xgap9", "d,s,t", MATCH_PRU_MULHSU_LHL, MASK_PRU_MULHSU_LHL, match_opcode, 0},
{"pru.mulhu.hhl",   "Xgap9", "d,s,t", MATCH_PRU_MULHU_HHL, MASK_PRU_MULHU_HHL, match_opcode, 0},
{"pru.mulhu.lhl",   "Xgap9", "d,s,t", MATCH_PRU_MULHU_LHL, MASK_PRU_MULHU_LHL, match_opcode, 0},
{"pru.or.hhl",      "Xgap9", "d,s,t", MATCH_PRU_OR_HHL, MASK_PRU_OR_HHL, match_opcode, 0},
{"pru.or.lhl",      "Xgap9", "d,s,t", MATCH_PRU_OR_LHL, MASK_PRU_OR_LHL, match_opcode, 0},
{"pru.rem.hhl",     "Xgap9", "d,s,t", MATCH_PRU_REM_HHL, MASK_PRU_REM_HHL, match_opcode, 0},
{"pru.rem.lhl",     "Xgap9", "d,s,t", MATCH_PRU_REM_LHL, MASK_PRU_REM_LHL, match_opcode, 0},
{"pru.remu.hhl",    "Xgap9", "d,s,t", MATCH_PRU_REMU_HHL, MASK_PRU_REMU_HHL, match_opcode, 0},
{"pru.remu.lhl",    "Xgap9", "d,s,t", MATCH_PRU_REMU_LHL, MASK_PRU_REMU_LHL, match_opcode, 0},
{"pru.sll.hhl",     "Xgap9", "d,s,t", MATCH_PRU_SLL_HHL, MASK_PRU_SLL_HHL, match_opcode, 0},
{"pru.sll.lhl",     "Xgap9", "d,s,t", MATCH_PRU_SLL_LHL, MASK_PRU_SLL_LHL, match_opcode, 0},
{"pru.slt.hhl",     "Xgap9", "d,s,t", MATCH_PRU_SLT_HHL, MASK_PRU_SLT_HHL, match_opcode, 0},
{"pru.slt.lhl",     "Xgap9", "d,s,t", MATCH_PRU_SLT_LHL, MASK_PRU_SLT_LHL, match_opcode, 0},
{"pru.sltu.hhl",    "Xgap9", "d,s,t", MATCH_PRU_SLTU_HHL, MASK_PRU_SLTU_HHL, match_opcode, 0},
{"pru.sltu.lhl",    "Xgap9", "d,s,t", MATCH_PRU_SLTU_LHL, MASK_PRU_SLTU_LHL, match_opcode, 0},
{"pru.sra.hhl",     "Xgap9", "d,s,t", MATCH_PRU_SRA_HHL, MASK_PRU_SRA_HHL, match_opcode, 0},
{"pru.sra.lhl",     "Xgap9", "d,s,t", MATCH_PRU_SRA_LHL, MASK_PRU_SRA_LHL, match_opcode, 0},
{"pru.srl.hhl",     "Xgap9", "d,s,t", MATCH_PRU_SRL_HHL, MASK_PRU_SRL_HHL, match_opcode, 0},
{"pru.srl.lhl",     "Xgap9", "d,s,t", MATCH_PRU_SRL_LHL, MASK_PRU_SRL_LHL, match_opcode, 0},
{"pru.sub.hhl",     "Xgap9", "d,s,t", MATCH_PRU_SUB_HHL, MASK_PRU_SUB_HHL, match_opcode, 0},
{"pru.sub.lhl",     "Xgap9", "d,s,t", MATCH_PRU_SUB_LHL, MASK_PRU_SUB_LHL, match_opcode, 0},
{"pru.xor.hhl",     "Xgap9", "d,s,t", MATCH_PRU_XOR_HHL, MASK_PRU_XOR_HHL, match_opcode, 0},
{"pru.xor.lhl",     "Xgap9", "d,s,t", MATCH_PRU_XOR_LHL, MASK_PRU_XOR_LHL, match_opcode, 0},
{"pru.lw.hl",       "Xgap9", "d,t(s!)", MATCH_PRU_LW_HL, MASK_PRU_LW_HL, match_opcode, 0},
{"pru.ky.ll",       "Xgap9", "d,s", MATCH_PRU_KY_LL, MASK_PRU_KY_LL, match_opcode, 0},
{"pru.lfsr.ll",     "Xgap9", "d,s", MATCH_PRU_LFSR_LL, MASK_PRU_LFSR_LL, match_opcode, 0},
{"pru.lut.hl",      "Xgap9", "d,s", MATCH_PRU_LUT_HL, MASK_PRU_LUT_HL, match_opcode, 0},
{"pru.lut.ll",      "Xgap9", "d,s", MATCH_PRU_LUT_LL, MASK_PRU_LUT_LL, match_opcode, 0},
